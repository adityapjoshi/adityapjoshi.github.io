...
I used the Codex Playground to generate the HTML, CSS, and JavaScript code for the website and heavily customized it to create a clean, modern personal portfolio website for to showcase my skills as a Sr. Test Manager and Product Owner.
